...
export const routes: Routes = [
  ...
  { path: 'iniciar-sesion', component: Login, title: 'Iniciar sesión | Argenda' },
  { path: 'registro', component: Register, title: 'Registro | Argenda' },
  { path: 'mis-turnos', component: MyAppointments, title: 'Mis turnos | Argenda' },
  { path: '**', redirectTo: '' },
];
